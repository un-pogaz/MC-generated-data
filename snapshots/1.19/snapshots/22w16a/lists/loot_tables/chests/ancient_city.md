...
| minecraft:diamond_hoe            |     1 |   2.3% | enchantments: {level: {type: "minecraft:uniform", min: 30.0, max: 50.0}, treasure: true} |
...
| minecraft:diamond_leggings       |     1 |   2.3% | enchantments: {level: {type: "minecraft:uniform", min: 30.0, max: 50.0}, treasure: true} |
