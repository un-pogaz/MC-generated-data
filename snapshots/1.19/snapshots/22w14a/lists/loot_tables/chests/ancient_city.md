...
| minecraft:diamond_hoe            |     1 |   2.4% | enchantments: {level: {type: "minecraft:uniform", min: 30.0, max: 50.0}, treasure: true} |
...
| minecraft:diamond_leggings       |     1 |   2.4% | enchantments: {level: {type: "minecraft:uniform", min: 30.0, max: 50.0}, treasure: true} |
| minecraft:enchanted_book         |     1 |   3.7% | enchantments: minecraft:swift_sneak                                                      |
...
| minecraft:iron_leggings          |     1 |   3.7% | enchantments: {level: {type: "minecraft:uniform", min: 20.0, max: 39.0}, treasure: true} |
| minecraft:echo_shard             |  1..3 |   4.9% |                                                                                          |
| minecraft:potion                 |  1..3 |   6.1% |                                                                                          |
| minecraft:enchanted_book         |     1 |   6.1% | enchantments: *                                                                          |
