...
| ------------------------------- | ----- | ------ | ---------------------------------- |
| 1 time                          |    -- |     -- |                                    |
| minecraft:crossbow              |     1 |    12% | enchantments: *                    |
...
| minecraft:enchanted_book        |     1 |    10% | enchantments: minecraft:soul_speed |
| empty                           |       |    50% |                                    |
|                                 |       |        |                                    |
| 2 time                          |    -- |     -- |                                    |
| minecraft:golden_boots          |     1 |   8.3% | enchantments: minecraft:soul_speed |
